...
// Updater is the updater for waterfall servers.
type Updater struct {
...
// NewWaterfallUpdater creates a new waterfall updater.
func NewWaterfallUpdater() *Updater {
	return &Updater{
...
func (u *Updater) Update() error {
	...
	if match, _ := regexp.MatchString("\\d*\\.\\d*\\.\\d", u.serverVersion); match {
		...
		versionGroupDetailsDownloadURL := u.waterfallAPI + "version_group/" + u.serverVersion
	...
	versionDetailsDownloadURL := u.waterfallAPI + "versions/" + version
