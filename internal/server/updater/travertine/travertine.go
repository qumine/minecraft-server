...
// Updater is the updater for travertine servers.
type Updater struct {
...
// NewTravertineUpdater creates a new travertine updater.
func NewTravertineUpdater() *Updater {
	return &Updater{
...
func (u *Updater) Update() error {
	...
	if match, _ := regexp.MatchString("\\d*\\.\\d*\\.\\d", u.serverVersion); match {
		...
		versionGroupDetailsDownloadURL := u.travertineAPI + "version_group/" + u.serverVersion
	...
	versionDetailsDownloadURL := u.travertineAPI + "versions/" + version
